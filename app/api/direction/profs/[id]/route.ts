...
// ) {
//   // Tout le corps de la fonction est dans un try/catch global :
//   // n'importe quelle exception inattendue renverra du JSON lisible
//   // au lieu de faire planter la route et renvoyer une page d'erreur HTML
//   // (ce qui causait le "Unexpected token ... is not valid JSON" côté client).
//   try {
...
//     //    On journalise chaque erreur individuellement sans stopper le process,
//     //    pour finir la suppression au maximum et savoir précisément ce qui a coincé.
...
//     // 6. Le prof, puis le profil, puis le compte auth — ces trois-là sont bloquants
...
//   } catch (err: any) {
//     // Filet de sécurité : toute exception inattendue renvoie du JSON exploitable
