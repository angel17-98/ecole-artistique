...
function BlocServices() {
  return (
    ...
    >
      {/* Gradient Crea'Star — vert vers doré */}
...
export default function DashboardClient({
  profile, foyer, eleves, fidelite, eleveData, candidaturesArrondies,
    ...
    <PlatformShell profile={profile} eleves={eleves} initialNotifications={initialNotifications} unreadDiscussions={unreadDiscussions}>
      <div className="space-y-5">
        ...
        {isPremium
          ...
          : <BlocStatNonPremium candidaturesArrondies={candidaturesArrondies} />
        }
