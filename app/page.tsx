...
//       {/* ── PARCOURS — deux grandes cartes immersives côte à côte ── */}
...
//               <p className="text-3xl uppercase tracking-[0.24em] text-primary/82">Nos parcours Crea'Star</p>
//               <div className="mt-4 flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
//                 {/* <h2 className="max-w-8xl text-3xl font-semibold leading-tight tracking-tight sm:text-5xl text-balance">
...
//             {/* Full Artist — vert émeraude profond */}
//             <Reveal delay={1}>
//               <Link
//                 href="/cours/full-artist"
//                 className="group relative block overflow-hidden rounded-[30px] transition hover:-translate-y-1"
//                 style={{ minHeight: "520px" }}
//               >
//                 <Image
//                   src="/programmes/full-artist.jpg"
//                   alt="Parcours Full Artist — CREA'STAR"
//                   fill unoptimized
//                   className="object-cover object-center transition duration-700 group-hover:scale-[1.04]"
//                   sizes="(min-width: 640px) 50vw, 100vw"
//                 />
//                 <div className="absolute inset-0 bg-[linear-gradient(180deg,rgba(8,24,18,0.30)_0%,rgba(8,24,18,0.55)_40%,rgba(8,24,18,0.92)_100%)]" />
//                 <div className="absolute inset-0 bg-[linear-gradient(90deg,rgba(22,92,71,0.18),transparent_60%)]" />

//                 <div className="absolute inset-x-0 bottom-0 p-7 sm:p-8">
//                   <p className="text-xs uppercase tracking-[0.24em] text-white/50">Parcours annuel</p>
//                   <h3 className="mt-3 text-4xl font-semibold leading-tight tracking-tight text-white sm:text-5xl">
//                     Full <span className="text-[rgb(185,151,83)]">Artist</span>
//                   </h3>
//                   <p className="mt-4 max-w-sm text-sm leading-7 text-white/68">
//                     Chant, danse, théâtre, écriture et studio — pour créer son univers
//                     et monter sur scène.
//                   </p>
//                   <div className="mt-5 flex flex-wrap gap-2">
//                     {["Identité artistique", "Studio", "Scène & Performance","Ecriture / Composition"].map((tag) => (
//                       <span key={tag} className="rounded-full border border-white/18 px-3 py-1 text-xs text-white/60">{tag}</span>
//                     ))}
//                   </div>
//                   <div className="mt-6 inline-flex items-center gap-2 text-sm font-medium text-[rgb(185,151,83)] transition group-hover:gap-3">
...
//                   sizes="(min-width: 640px) 50vw, 100vw"
//                 />
//                 <div className="absolute inset-0 bg-[linear-gradient(180deg,rgba(20,14,4,0.28)_0%,rgba(20,14,4,0.52)_40%,rgba(20,14,4,0.92)_100%)]" />
//                 <div className="absolute inset-0 bg-[linear-gradient(90deg,rgba(120,85,20,0.16),transparent_60%)]" />

//                 <div className="absolute inset-x-0 bottom-0 p-7 sm:p-8">
//                   <p className="text-xs uppercase tracking-[0.24em] text-white/50">Parcours annuel</p>
//                   <h3 className="mt-3 text-4xl font-semibold leading-tight tracking-tight text-white sm:text-5xl">
//                     Comédie <span className="text-[rgb(185,151,83)]">Musicale</span>
//                   </h3>
//                   <p className="mt-4 max-w-sm text-sm leading-7 text-white/68">
//                     Chant, danse et théâtre au service d'un projet collectif fort —
//                     jusqu'à la construction d'un spectacle original.
//                   </p>
//                   <div className="mt-5 flex flex-wrap gap-2">
//                     {["Projet collectif", "Mise en scène","Ecriture"].map((tag) => (
//                       <span key={tag} className="rounded-full border border-white/18 px-3 py-1 text-xs text-white/60">{tag}</span>
//                     ))}
//                   </div>
//                   <div className="mt-6 inline-flex items-center gap-2 text-sm font-medium text-[rgb(185,151,83)] transition group-hover:gap-3">
    ...
    <main className="min-h-screen text-foreground">
      ...
      */}
      ...
      <section className="relative bg-[rgb(239,244,239)] text-foreground overflow-hidden">
        ...
        <div className="site-shell-wide px-5 py-16 md:px-10 lg:px-14 lg:py-24">
      ...
      <section className="relative bg-background overflow-hidden">
        ...
        <div className="site-shell-wide px-5 py-16 md:px-10 lg:px-14 lg:py-28">
          <Reveal>
          ...
          <div className="mt-10 divide-y divide-black/8 lg:mt-14">
            {values.map((value, index) => (
              <Reveal key={value.title} delay={(index % 3) as 0 | 1 | 2 | 3}>
                ...
                */}
                <div className="flex flex-col gap-2 py-6 sm:py-8 lg:grid lg:grid-cols-[64px_1fr_2fr] lg:gap-14 lg:py-10">
